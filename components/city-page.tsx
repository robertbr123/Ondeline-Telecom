...
export function CityPage({ name, slug, status, benefits, benefitDescriptions, features }: CityPageProps) {
        ...
        <section className="relative pt-20 pb-32 px-4 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto mb-8 leading-relaxed">
              Conectando a cidade de {name} com internet de alta velocidade, fibra óptica e suporte 24/7
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                {isCovered ? "Contratar Agora" : "Pré-cadastro"} <ArrowRight size={20} />
              </Button>
              <Button
                variant="outline"
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="p-6 rounded-xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 hover:border-cyan-500/50 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">{features.speed}</h3>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 hover:border-cyan-500/50 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">{features.technology}</h3>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 hover:border-cyan-500/50 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">{features.uptime}</h3>
              ...
              <div className="p-6 rounded-xl bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 hover:border-cyan-500/50 transition-all duration-300">
                ...
                <h3 className="text-xl font-bold text-white mb-2">{features.support}</h3>
              ...
              {benefits.map((benefit, idx) => (
                <div key={idx} className="flex items-start gap-4 p-6 rounded-xl border border-border bg-card/50 hover:border-primary/50 transition">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">{benefitDescriptions[idx]}</p>
                  </div>
                </div>
              ))}
            </div>
