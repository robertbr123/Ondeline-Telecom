...
async function createPagesTable() {
  try {
    ...
    await query('CREATE INDEX IF NOT EXISTS idx_pages_active ON pages(active)');
    await query('CREATE INDEX IF NOT EXISTS idx_pages_updated_at ON pages(updated_at)');
