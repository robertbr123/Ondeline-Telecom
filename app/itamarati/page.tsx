...
export const metadata: Metadata = {
  title: "Internet em Itamarati - Ondeline Telecom",
  description: "Internet de alta velocidade em Itamarati, Amazonas. Planos a partir de R$ 100 com suporte 24/7 e instalação rápida.",
  keywords: ["internet itamarati", "provedor itamarati", "wifi itamarati", "fibra óptica itamarati", "ondeline"],
}
      ...
      <section className="relative min-h-[70vh] flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 px-4 py-20">
        ...
        <div className="max-w-5xl mx-auto text-center z-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 mb-6">
            ...
            <span className="text-sm font-medium text-primary">Itamarati, Amazonas</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-slate-300 mb-8 max-w-3xl mx-auto text-balance">
            Conectando Itamarati com internet rápida e confiável. 
          ...
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <a
              href={`https://wa.me/5592984607721?text=Olá! Gostaria de contratar internet em Itamarati`}
              target="_blank"
      ...
      <section className="py-20 px-4 bg-slate-800">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-white text-center mb-12">
            Por que escolher a Ondeline em Itamarati?
          </h2>
          
          <div className="space-y-6">
            <div className="p-6 rounded-xl bg-slate-900/50 border border-slate-700">
              <h3 className="text-xl font-bold text-white mb-2">Cobertura em toda Itamarati</h3>
